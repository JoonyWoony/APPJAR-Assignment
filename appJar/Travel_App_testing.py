...
def korea():  # Makes life so much easier
    ...
    loginedapp.setImage("CountryImage", 'korea.jpg')
    loginedapp.reloadImage("CountryImage", 'korea.jpg')
...
def america():
    ...
    loginedapp.setImage("CountryImage", 'america.jpg')
    loginedapp.reloadImage("CountryImage", 'america.jpg')
...
def bali():
    ...
    loginedapp.setImage("CountryImage", 'bali.jpg')
    loginedapp.reloadImage("CountryImage", 'bali.jpg')
...
def australia():
    ...
    loginedapp.setImage("CountryImage", 'australia.jpg')
    loginedapp.reloadImage("CountryImage", 'australia.jpg')
...
def japan():
    ...
    loginedapp.setImage("CountryImage", 'japan.jpg')
    loginedapp.reloadImage("CountryImage", 'japan.jpg')
...
with gui("Travel App", "1980x1080", bg='yellow', font={'size': 16}) as loginedapp:
    username = app.entry("Username")
    ...
    loginedapp.addLabel(
        "Statistics", "Area: 42.38 km²\nTemperature: 27 °C, Wind S at 13 km/h\nPopulation: 74,800\nPopular Places to Visit: Sacred Monkey Forest Sanctuary, Saraswati Temple, Campuhan Ridge Walk")
    loginedapp.image("CountryImage", 'bali.jpg')
